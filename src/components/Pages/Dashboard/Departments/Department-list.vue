<template>
  <div>
    <Card title="Department List" noborder>
      <vue-good-table
        class="-mx-6"
        :columns="columns"
        styleClass=" vgt-table  table-head   v-middle striped lesspadding2 listview"
        :rows="this.$store.state.department.departments"
        :pagination-options="{
          enabled: true,
          perPage: perpage,
        }"
      ...
      >
        ...
        <template #pagination-bottom="props">
          <div class="py-4 px-3 justify-center flex">
            <Pagination
              :total="$store.state.department.departments.length"
              :current="current"
              :per-page="perpage"
              :pageRange="pageRange"
      ...
      actions: [
        {
          ...
          icon: "heroicons:eye",
          doit: () => {
            this.$router.push({ name: "department-details" });
          },
        },
        {
          name: "edit",
        ...
        },
        {
          ...
          doit: (data) => {
            this.$store.dispatch("removeDepartment", data);
          },
        },
      ],
