      ...
      >
        <template v-slot:table-row="props">
          ...
          <span v-if="props.column.field == 'assignto'" class="block w-full">
            <div
              class="flex justify-end sm:justify-start lg:justify-end xl:justify-start -space-x-1"
            >
              <div
        ...
        <template #pagination-bottom="props">
          <div class="py-4 px-3 justify-center flex">
            <Pagination
              :total="$store.state.center.centers.length"
              :current="current"
              :per-page="perpage"
              :pageRange="pageRange"
      ...
      actions: [
        {
          ...
          icon: "heroicons:eye",
          doit: () => {
            this.$router.push({ name: "center-details" });
          },
        },
        {
          name: "edit",
          ...
          doit: (data) => {
            this.$store.dispatch("updateCenter", data);
          },
        },
        {
          name: "delete",
          ...
          doit: (data) => {
            this.$store.dispatch("removeCenter", data);
          },
        },
      ],
