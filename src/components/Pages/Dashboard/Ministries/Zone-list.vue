      ...
      >
        ...
        <template #pagination-bottom="props">
          <div class="py-4 px-3 justify-center flex">
            <Pagination
              :total="$store.state.zone.zones.length"
              :current="current"
              :per-page="perpage"
              :pageRange="pageRange"
      ...
      actions: [
        {
          ...
          icon: "heroicons:eye",
          doit: () => {
            this.$router.push({ name: "zone-details" });
          },
        },
        {
          name: "edit",
        ...
        },
        {
          ...
          doit: (data) => {
            this.$store.dispatch("removeZone", data);
          },
        },
      ],
