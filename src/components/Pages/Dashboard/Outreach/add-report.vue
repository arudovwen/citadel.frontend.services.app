...
const { value: outreachOutcome, errorMessage: outreachOutcomeError } = useField("outreachOutcome");

const { value: adultTotal, errorMessage: adultTotalError } =
  useField("detailOfConverts[0].adult");
const { value: youthTotal, errorMessage: youthTotalError } =
  useField("detailOfConverts[0].youth");
const { value: teenagerTotal, errorMessage: teenagerTotalError } =
  useField("detailOfConverts[0].teenager");
const { value: childrenTotal, errorMessage: childrenTotalError } =
  useField("detailOfConverts[0].children");
const { value: maleTotal, errorMessage: maleTotalError } =
  useField("detailOfConverts[0].male");
const { value: femaleTotal, errorMessage: femaleTotalError } =
  useField("detailOfConverts[0].female");
...
const onSubmit = handleSubmit((values) => {
  ...
  reqData.detailOfConverts[0].adult = parseInt(values.detailOfConverts[0].adult),
  reqData.detailOfConverts[0].youth = parseInt(values.detailOfConverts[0].youth),
  reqData.detailOfConverts[0].teenager = parseInt(values.detailOfConverts[0].teenager),
  reqData.detailOfConverts[0].children = parseInt(values.detailOfConverts[0].children),
  reqData.detailOfConverts[0].male = parseInt(values.detailOfConverts[0].male),
  reqData.detailOfConverts[0].female = parseInt(values.detailOfConverts[0].female),
  delete(reqData.date)
