        ...
        <div class="">
          ...
          <div class="flex-1 border rounded">
            <div class="flex gap-x-6 border-b px-4 py-2 justify-between">
              ...
              <div class="flex gap-x-5 items-center">
                <span class="flex gap-x-3 items-center"
                  ><span>{{ report?.detailOfConverts[0]?.adult }}</span></span
                >
            ...
            <div class="flex gap-x-6 border-b px-4 py-2 justify-between">
              ...
              <div class="flex gap-x-5 items-center">
                <span class="flex gap-x-3 items-center"
                  ><span>{{ report?.detailOfConverts[0]?.youth }}</span></span
                >
                <!-- <div class="border-l h-4"></div> -->
                <!-- <span class="flex gap-x-3 items-center"
            ...
            <div class="flex gap-x-6 border-b px-4 py-2 justify-between">
              ...
              <div class="flex gap-x-5 items-center">
                <span class="flex gap-x-3 items-center"
                  ><span>{{
                    report?.detailOfConverts[0]?.teenager
                  }}</span></span
                >
                <!-- <div class="border-l h-4"></div> -->
                <!-- <span class="flex gap-x-3 items-center"
            ...
            <div class="flex gap-x-6 border-b px-4 py-2 justify-between">
              ...
              <div class="flex gap-x-5 items-center">
                <span class="flex gap-x-3 items-center"
                  ><span>{{
                    report?.detailOfConverts[0]?.children
                  }}</span></span
                >
                <!-- <div class="border-l h-4"></div> -->
                <!-- <span class="flex gap-x-3 items-center"
      ...
      <template v-slot:footer>
        <div class="flex gap-x-5">
          ...
          <Button
            ...
            btnClass="btn-dark btn-sm bg-danger-500"
            @click="
              dispatch('deleteOutreachReport', {
                id:
                  report?.detailOfConverts[0]?.outreachReportId ||
                  report?.detailOfConverts[0]?.id,
              })
            "
          />
        </div>
