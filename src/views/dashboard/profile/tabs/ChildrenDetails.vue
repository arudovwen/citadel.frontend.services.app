    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      ...
      >
        <Textinput
          ...
          name="firstName"
          v-model="values.initialValues[idx].firstName"
        ...
        <Textinput
          ...
          name="lastName"
          v-model="values.initialValues[idx].lastName"
          :error="lastNameError"
          classInput="h-[40px]"
        />
        <Textinput
          ...
          name="middleName"
          v-model="values.initialValues[idx].middleName"
        ...
        <Textinput
          ...
          name="email"
          v-model="values.initialValues[idx].email"
          :error="emailError"
          classInput="h-[40px]"
        />
        <Textinput
          ...
          name="mobile1"
          v-model="values.initialValues[idx].mobile1"
          :error="mobile1Error"
          classInput="h-[40px]"
        />
        ...
        <Textinput
          ...
          name="mobile2"
          v-model="values.initialValues[idx].mobile2"
          :error="mobile2Error"
          classInput="h-[40px]"
        />
        ...
        <CustomVueSelect
          :key="field.idx"
          name="title"
          v-model="values.initialValues[idx].title"
          :modelValue="title"
          :error="titleError"
          :options="titleMenu"
          label="Title"
        ...
        <CustomVueSelect
          :key="field.idx"
          name="gender"
          v-model="values.initialValues[idx].gender"
          :modelValue="gender"
          :error="genderError"
          :options="genderMenu"
          label="Gender"
        ...
        <FromGroup label="DOB" name="d1">
          <flat-pickr
            :key="field.idx"
            v-model="values.initialValues[idx].DOB"
            class="form-control"
            id="d1"
